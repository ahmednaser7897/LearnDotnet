namespace Linq.Anatomy
{
    internal class LinqAnatomy
    {
        ...
        public static void DemoFluentAPI()
        {
            // ### Fluent API ###
        ...
        public static void DemoIEnumerableIQueryable()
        {
            var deck = new Deck();
        ...
        public static void DemoExecutionOrder()
        {
        ...
        public static void DemoImmediateExecution()
        {
        ...
        public static void DemoDeferredExecution()
        {
        ...
        public static void DemoDeferredStreamedExecution()
        {
        ...
        public static void DemoDeferredNonStreamedExecution()
        {
        ...
        public static void DemoFilterOrder()
        {
