namespace CsharpFundamentals.Streams
{
    internal class FileStreams
    {
        ...
        {
            string path = "D:\\programing\\dotnet\\LearnDotnet\\CsharpBasics\\Streams\\sample.txt";
        ...
        static void Example02()
        {
            ...
            using (var fs = new FileStream(path, FileMode.Open, FileAccess.ReadWrite))
            {
                ...
                var newPath = "D:\\programing\\dotnet\\LearnDotnet\\CsharpBasics\\Streams\\sample1.txt";
        ...
        {
            string path = "D:\\programing\\dotnet\\LearnDotnet\\CsharpBasics\\Streams\\sample2.txt"; ;
        ...
        {
            string path = "D:\\programing\\dotnet\\LearnDotnet\\CsharpBasics\\Streams\\sample3.txt";
        ...
        {
            string path = "D:\\programing\\dotnet\\LearnDotnet\\CsharpBasics\\Streams\\sample4.txt";
        ...
        {
            string path = "D:\\programing\\dotnet\\LearnDotnet\\CsharpBasics\\Streams\\sample5.txt";
